...
{  
        ...
        $credentials =  $invoice_pay_method['efipay'] ;
        ...
        if($args == 'options'){
                ...
                $options = [
                    ...
                    'sandbox' => isset($credentials['sandbox']) ? true : false,
                    "debug" => isset($credentials['sandbox']) ? true : false,
                   "certificate" => storage_path( 'homologacao-143228-localhost-tests.p12' ),
                    "timeout" => 30,
               ...
               // dd($options);
                ...
                if($args == 'configurations'){
                        ...
                        $configurations = [
                            ...
                            'interest' => intval(clear($credentials['juros'])),
                        ];
    ...
    public function dateCheck($id)
    {
        ...
        if(strtotime(date('Y-m-d')) > strtotime($invoice->due_date)){
            ...
            $fine = ( (int)  clear($data_method->EfiPay->multa) / 100 ) *  $invoice->amount / 100;

            $interest = ( (int) clear($data_method->EfiPay->juros) /100 ) * $invoice->amount / 100;
            ...
            $items = json_decode( $invoice->items , true);
                ...
                $items[] = [
                            ...
                            "name" => "Multa por Atraso: " . $data_method->EfiPay->multa .'%',
                            "amount" => "1",
                            "value" => (int) $fine
                ...
                $items[] = [
                            ...
                            "name" => "Juros Diários: " . $data_method->EfiPay->juros .'% - ' . $days . " Dia$s de Atraso" ,
                            "amount" => "1",
    ...
    public function payCharge($id)
    {
        ...
        $metadata = [
            'custom_id' => strval($id),
            'notification_url'=> tenant('principal_domain') . '/return/efipay',
        ];
        ...
        try {
            ...
            $response = $api->createOneStepCharge($params = [], $body);
                        ...
                        $invoice->fill([
                            ...
                            'invoice_url' => $response['data']['billet_link'] 
                            ]);
                        ...
                        return $response['data']['billet_link'];
    ...
    public function payCharge22($id)
    {
